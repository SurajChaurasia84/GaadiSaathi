...
class _VehicleDetailScreenState extends State<VehicleDetailScreen> {
  ...
  late final Stream<DocumentSnapshot<Map<String, dynamic>>> _vehicleStream;
  ...
  Future<void> _navigateToLocation(BuildContext context, Vehicle vehicle) async {
  ...
  void _showCallWarningDialog(BuildContext context, Vehicle vehicle) {
    showDialog(
      context: context,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _makePhoneCall(context, vehicle);
              },
  ...
  Future<void> _makePhoneCall(BuildContext context, Vehicle vehicle) async {
    final String? phone = vehicle.phoneNumber;
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to delete this vehicle? This action will permanently remove the listing and its photos.',
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(dialogContext),
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  await Provider.of<AppState>(context, listen: false).deleteVehicle(vehicle);
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData && snapshot.data!.exists && snapshot.data!.data() != null) {
          vehicle = Vehicle.fromMap(snapshot.data!.data()!, snapshot.data!.id);
        }
          ...
          body: CustomScrollView(
            slivers: [
              ...
              SliverAppBar(
                ...
                actions: [
                  if (vehicle.ownerGmail == appState.currentGmail)
                    CircleAvatar(
                      backgroundColor: const Color(0x66000000),
                      child: PopupMenuButton<String>(
                        ...
                        onSelected: (value) {
                          if (value == 'edit') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => AddEditVehicleScreen(initialVehicle: vehicle),
                              ),
                            );
                        ...
                        itemBuilder: (BuildContext context) => [
                          PopupMenuItem<String>(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.edit_rounded, color: context.textColor, size: 18),
                                const SizedBox(width: 8),
                                Text('Edit', style: TextStyle(color: context.textColor, fontSize: 14)),
                              ],
                            ),
                          ),
                          PopupMenuItem<String>(
                      ...
                      GestureDetector(
                        onTap: () {
                          _openFullScreenImage(
                            context,
                            _showingOutside ? vehicle.outsidePhotoUrl : vehicle.insidePhotoUrl,
                          );
                        },
                        child: _buildVehicleImage(
                          _showingOutside ? vehicle.outsidePhotoUrl : vehicle.insidePhotoUrl,
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                height: 8,
                                decoration: BoxDecoration(
                                  color: vehicle.isServiceOn ? const Color(0xFF10B981) : Colors.grey,
                                  shape: BoxShape.circle,
                                ),
                              ),
                              const SizedBox(width: 6),
                              Text(
                                vehicle.isServiceOn ? 'Available' : 'Unavailable',
                                style: TextStyle(
                                  color: vehicle.isServiceOn ? const Color(0xFF10B981) : Colors.grey,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () => _navigateToLocation(context, vehicle),
                                    child: Text(
                                      '${(vehicle.address != null && vehicle.address!.isNotEmpty) ? vehicle.address! : 'Location not specified'} • ${distance.toStringAsFixed(1)} Km away',
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                      ...
                      if (vehicle.ownerGmail == appState.currentGmail) ...[
                        ...
                        Row(
                          children: [
                            ...
                            if (vehicle.phoneNumber != null && vehicle.phoneNumber!.isNotEmpty) ...[
                              const SizedBox(width: 12),
                              GestureDetector(
                                onTap: () => _showCallWarningDialog(context, vehicle),
                                child: Container(
                                  width: 54,
                                  height: 54,
                                  decoration: BoxDecoration(
